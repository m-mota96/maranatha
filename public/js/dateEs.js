function dateEs(date, separator = null, abr = null, time = null) {
    ...
    return date.substring(8, 10) + separator + ((abr == null) ? months[parseInt(date.substring(5, 7))] : monthsAbr[parseInt(date.substring(5, 7))]) + separator + date.substring(0,4) + time;
}